    ...
    <nav className="w-full bg-white shadow-md fixed top-0 left-0 z-50">
      ...
      {openMenu && (
        <div className="md:hidden bg-white shadow-md px-6 py-4 flex flex-col gap-3 text-gray-700 font-medium">
          <span className="hover:text-blue-600 cursor-pointer">Startup</span>

          <details className="cursor-pointer">
            <summary className="flex items-center gap-1">
              Registrations <FaChevronDown size={12} />
            </summary>
            <div className="flex flex-col gap-2 mt-2 ml-3 text-sm">
              ...
              <span>Public Ltd Company</span>
              <span>Producer Company</span>
              <span>Indian Subsidiary</span>
            </div>
          </details>

          <span className="hover:text-blue-600 cursor-pointer">Trademark</span>
          <span className="hover:text-blue-600 cursor-pointer">GST</span>
          <span className="hover:text-blue-600 cursor-pointer">Digital Service</span>

          <div className="flex gap-4 pt-3 border-t mt-3">
            <button className="bg-blue-600 text-white px-4 py-1.5 rounded-md font-medium hover:bg-blue-700">
              Sign Up
            </button>
          </div>
        </div>
